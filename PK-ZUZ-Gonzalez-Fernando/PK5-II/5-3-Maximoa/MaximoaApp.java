...
class Agenda {
	...
	public synchronized int sartu(int pid, String spaceP, int zenb) throws InterruptedException {
		...
		notifyAll(); // hari guztieei notifikatu haien eragiketak egin dezaten eta hartzeko prest
...
//	when(i>0) pr[PR].hartu
	public synchronized int[] hartu(int pid, String spaceP) throws InterruptedException {
		...
		j = j + 1;
		i = i - 2;
		notify(); // itxoiten baldin eta inork sartu egiten e< badu ezin izango da gehiagorik
					// egin.
		return zenb;
	}
